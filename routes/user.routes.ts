...
export class userRoutes {
    ...
    constructor() {
        ...
        this.router.get('/getbyid/:userId', authMiddleware, this.uc.getUserByID);

        // Route to update user details
        this.router.put('/update/:userId', authMiddleware, bodyValidator(usersSchema), this.uc.updateUser);

        // Route to delete a user
        this.router.delete('/delete/:userId', authMiddleware, this.uc.deleteUser);
    }
}